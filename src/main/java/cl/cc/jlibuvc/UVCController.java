 ...
 */
@Properties({
    @Platform(include = {"libuvc/libuvc.h"})})
public class UVCController implements InfoMapper {
    ...
    */
    ...
    public static class UVCDeviceDescriptor extends Pointer {
         ...
         * @return
         */
        public native @Cast("uint16_t") short idVendor(); public native UVCDeviceDescriptor idVendor(short idVendor);
         ...
         * @return
         */
        public native @Cast("uint16_t") short idProduct(); public native UVCDeviceDescriptor idProduct(short idProduct);
         ...
         * @return
         */
        public native @Cast("uint16_t") short bcdUVC(); public native UVCDeviceDescriptor bcdUVC(short bcdUVC);
         ...
         * @return 
         */
        public native @Cast("char*") BytePointer serialNumber(); public native UVCDeviceDescriptor serialNumber(BytePointer serialNumber); 
         ...
         * @return 
         */
        public native @Cast("char*") BytePointer manufacturer(); public native UVCDeviceDescriptor manufacturer(BytePointer manufacturer); 
         ...
         * @return 
         */
        public native @Cast("char*") BytePointer product(); public native UVCDeviceDescriptor product(BytePointer product); 
    };
    ...
    */
    ...
    public static class UVCStreamCtrl extends Pointer {
        ...
        public native @Cast("uint16_t") short bmHint(); public native UVCStreamCtrl bmHint(short bmHint);
        public native @Cast("uint8_t") byte bFormatIndex(); public native UVCStreamCtrl bFormatIndex(byte bFormatIndex);
        public native @Cast("uint8_t") byte bFrameIndex(); public native UVCStreamCtrl bFrameIndex(byte bFrameIndex);
        public native @Cast("uint32_t") int dwFrameInterval(); public native UVCStreamCtrl dwFrameInterval(int wKeyFrameRate);
        public native @Cast("uint16_t") short wKeyFrameRate(); public native UVCStreamCtrl wKeyFrameRate(short wKeyFrameRate);
        public native @Cast("uint16_t") short wPFrameRate(); public native UVCStreamCtrl wPFrameRate(short wPFrameRate);
        public native @Cast("uint16_t") short wCompQuality(); public native UVCStreamCtrl wCompQuality(short wCompQuality);
        public native @Cast("uint16_t") short wCompWindowSize(); public native UVCStreamCtrl wCompWindowSize(short wCompWindowSize);
    ...
    */
    ...
    public static class UVCFrame extends Pointer {
        ...
        public native @Cast("uint32_t") int height(); public native UVCFrame height(int height);        
        ...
        public native @ByVal TimeVal capture_time(); public native UVCFrame capture_time(@ByVal TimeVal capture_time);
  
        /** Handle on the device that produced the image.
        * @warning You must not call any uvc_* functions during a callback. */
        public native UVCDeviceHandle source(); public native UVCFrame source(UVCDeviceHandle source);
    ...
    */
    ...
    public static native int uvc_get_stream_ctrl_format_size(UVCDeviceHandle devh, UVCStreamCtrl ctrl, @Cast("uvc_frame_format") int format, int width, int height, int fps);
    ...
    public static native int uvc_get_scanning_mode(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer mode, @Cast("uvc_req_code") int req_code);
    ...
    public static native int uvc_get_ae_priority(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer priority, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_ae_priority(UVCDeviceHandle devh, @Cast("uint8_t") byte priority);

    public static native int uvc_get_exposure_abs(UVCDeviceHandle devh, @Cast("uint32_t *") IntBuffer time, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_exposure_abs(UVCDeviceHandle devh, @Cast("uint32_t") int time);
    public static native int uvc_get_exposure_rel(UVCDeviceHandle devh, @Cast("int8_t *") ByteBuffer step, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_exposure_rel(UVCDeviceHandle devh, @Cast("int8_t") byte step);
    
    public static native int uvc_get_focus_abs(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer focus, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_focus_abs(UVCDeviceHandle devh, @Cast("uint16_t") short focus);
    public static native int uvc_get_focus_rel(UVCDeviceHandle devh, @Cast("int8_t *") ByteBuffer focus_rel, @Cast("uint8_t *") ByteBuffer speed, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_focus_rel(UVCDeviceHandle devh, @Cast("int8_t") byte focus_rel, @Cast("uint8_t") byte speed);
    public static native int uvc_get_focus_simple_range(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer focus, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_focus_simple_range(UVCDeviceHandle devh, @Cast("uint8_t") byte focus);
    public static native int uvc_get_focus_auto(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer state, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_focus_auto(UVCDeviceHandle devh, @Cast("uint8_t") byte state);

    public static native int uvc_get_iris_abs(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer iris, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_iris_abs(UVCDeviceHandle devh, @Cast("uint16_t") short iris);
    public static native int uvc_get_iris_rel(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer iris_rel, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_iris_rel(UVCDeviceHandle devh, @Cast("uint8_t") byte iris_rel);
    
    public static native int uvc_get_zoom_abs(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer focal_length, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_zoom_abs(UVCDeviceHandle devh, @Cast("uint16_t") short focal_length);
    public static native int uvc_get_zoom_rel(UVCDeviceHandle devh, @Cast("int8_t *") ByteBuffer zoom_rel, @Cast("uint8_t *") ByteBuffer digital_zoom, @Cast("uint8_t *") ByteBuffer speed, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_zoom_rel(UVCDeviceHandle devh, @Cast("int8_t") byte zoom_rel, @Cast("uint8_t") byte digital_zoom, @Cast("uint8_t") byte speed);
    ...
    public static native int uvc_get_pantilt_rel(UVCDeviceHandle devh, @Cast("int8_t *") ByteBuffer pan_rel, @Cast("uint8_t *") ByteBuffer pan_speed, @Cast("int8_t *") ByteBuffer tilt_rel, @Cast("uint8_t *") ByteBuffer tilt_speed, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_pantilt_rel(UVCDeviceHandle devh, @Cast("int8_t") byte pan_rel, @Cast("uint8_t") byte pan_speed, @Cast("int8_t") byte tilt_rel, @Cast("uint8_t") byte tilt_speed);
    ...
    public static native int uvc_get_roll_rel(UVCDeviceHandle devh, @Cast("int8_t *") ByteBuffer roll_rel, @Cast("uint8_t *") ByteBuffer speed, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_roll_rel(UVCDeviceHandle devh, @Cast("int8_t") byte roll_rel, @Cast("uint8_t") byte speed);
    
    public static native int uvc_get_privacy(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer privacy, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_privacy(UVCDeviceHandle devh, @Cast("uint8_t") byte privacy);

    public static native int uvc_get_digital_window(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer window_top, @Cast("uint16_t *") ShortBuffer window_left, @Cast("uint16_t *") ShortBuffer window_bottom, @Cast("uint16_t *") ShortBuffer window_right, @Cast("uint16_t *") ShortBuffer num_steps, @Cast("uint16_t *") ShortBuffer num_steps_units, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_digital_window(UVCDeviceHandle devh, @Cast("uint16_t") short window_top, @Cast("uint16_t") short window_left, @Cast("uint16_t") short window_bottom, @Cast("uint16_t") short window_right, @Cast("uint16_t") short num_steps, @Cast("uint16_t") short num_steps_units);
    public static native int uvc_get_digital_roi(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer roi_top, @Cast("uint16_t *") ShortBuffer roi_left, @Cast("uint16_t *") ShortBuffer roi_bottom, @Cast("uint16_t *") ShortBuffer roi_right, @Cast("uint16_t *") ShortBuffer auto_controls, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_digital_roi(UVCDeviceHandle devh, @Cast("uint16_t") short roi_top, @Cast("uint16_t") short roi_left, @Cast("uint16_t") short roi_bottom, @Cast("uint16_t") short roi_right, @Cast("uint16_t") short auto_controls);

    public static native int uvc_get_backlight_compensation(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer backlight_compensation, @Cast("uvc_req_code") int req_code);
    ...
    public static native int uvc_get_contrast(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer contrast, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_contrast(UVCDeviceHandle devh, @Cast("uint16_t") short contrast);
    public static native int uvc_get_contrast_auto(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer contrast_auto, @Cast("uvc_req_code") int req_code);
    ...
    public static native int uvc_get_power_line_frequency(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer power_line_frequency, @Cast("uvc_req_code") int req_code);
    ...
    public static native int uvc_get_hue_auto(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer hue_auto, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_hue_auto(UVCDeviceHandle devh, @Cast("uint8_t") byte hue_auto);

    public static native int uvc_get_saturation(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer saturation, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_saturation(UVCDeviceHandle devh, @Cast("uint16_t") short saturation);

    public static native int uvc_get_sharpness(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer sharpness, @Cast("uvc_req_code") int req_code);
    ...
    public static native int uvc_get_white_balance_temperature(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer temperature, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_white_balance_temperature(UVCDeviceHandle devh, @Cast("uint16_t") short temperature);
    public static native int uvc_get_white_balance_temperature_auto(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer temperature_auto, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_white_balance_temperature_auto(UVCDeviceHandle devh, @Cast("uint8_t") byte temperature_auto);
    public static native int uvc_get_white_balance_component(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer blue, @Cast("uint16_t *") ShortBuffer red, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_white_balance_component(UVCDeviceHandle devh, @Cast("uint16_t") short blue, @Cast("uint16_t") short red);
    public static native int uvc_get_white_balance_component_auto(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer white_balance_component_auto, @Cast("uvc_req_code") int req_code);
    ...
    public static native int uvc_get_digital_multiplier(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer multiplier_step, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_digital_multiplier(UVCDeviceHandle devh, @Cast("uint16_t") short multiplier_step);
    public static native int uvc_get_digital_multiplier_limit(UVCDeviceHandle devh, @Cast("uint16_t *") ShortBuffer multiplier_step, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_digital_multiplier_limit(UVCDeviceHandle devh, @Cast("uint16_t") short multiplier_step);

    public static native int uvc_get_analog_video_standard(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer video_standard, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_analog_video_standard(UVCDeviceHandle devh, @Cast("uint8_t") byte video_standard);
    public static native int uvc_get_analog_video_lock_status(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer status, @Cast("uvc_req_code") int req_code);
    public static native int uvc_set_analog_video_lock_status(UVCDeviceHandle devh, @Cast("uint8_t") byte status);

    public static native int uvc_get_input_select(UVCDeviceHandle devh, @Cast("uint8_t *") ByteBuffer selector, @Cast("uvc_req_code") int req_code);
